...
exports.getBookings = function () {
    var booking = Booking_1.default.find({}, '_id passenger').populate('passenger flights').then(function (bookings) {
        var filteredBookings = bookings.map(function (booking) {
            return {
...
exports.getBookingsByUid = function () {
